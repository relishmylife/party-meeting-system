...
export const Toast: React.FC<ToastProps> = ({ message, type, onClose, duration = 3000 }) => {
  ...
  const getTypeStyles = () => {
    switch (type) {
      ...
      default:
        return 'bg-neutral-100 border-neutral-500 text-neutral-800';
    }
  };
  ...
  return (
    <div className={`fixed top-4 right-4 z-50 animate-slideIn max-w-md`}>
      <div className={`flex items-start gap-3 p-4 rounded-lg border-l-4 shadow-lg ${getTypeStyles()}`}>
