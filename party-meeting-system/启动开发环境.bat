...
REM 党组织生活会议管理系统 - Windows开发环境启动脚本
...
REM 启动开发服务器
if "%PACKAGE_MANAGER%"=="pnpm" (
    start "开发服务器 - %PROJECT_NAME%" /wait cmd /c "pnpm run dev"
) else (
    start "开发服务器 - %PROJECT_NAME%" /wait cmd /c "npm run dev"
)
